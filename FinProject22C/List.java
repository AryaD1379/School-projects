...
public class List {
     ...
     */
    public Animal getFirst() throws NoSuchElementException{
    	if (length == 0)
     ...
     * @throws NoSuchElementException when precondition is violated
     */
    public Animal getLast() throws NoSuchElementException{
    	if (length == 0)
     ...
     */
    public Animal getIterator() throws NullPointerException{
    	if (iterator == null)
	...
	*/
	private boolean inSortedOrder(Node node) {
		if (node.next == null)
			return true;
		if (node.data.getName().
				compareTo(node.next.data.getName()) > 0)
			return false;
     ...
     * unchanged!
     */
    public int linearSearch(Animal element) {
    	Node temp = first;
    	int loc = 1;
    	while (temp != null) {
     ...
     */
    public int binarySearch(Animal value) throws IllegalStateException {
    	if (!inSortedOrder())
     ...
     */
    private int binarySearch(int low, int high, Animal value) {
    	if (high < low)
    		return -1;
    	...
    	if (temp.data.equals(value))
    		return mid;
    	else if (temp.data.getName().compareTo(value.getName()) > 0)
   ...
   public void advanceToIndex(int index) throws IndexOutOfBoundsException {
     ...
     */
    public void addIterator(Animal data) throws NullPointerException {
    	if (iterator == null)
